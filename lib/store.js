...
const extraMenu = [
 ['salad-fruit','Fruit Salad','سلطة فواكه','Salads',600,'bar'],['salad-fruit-nutella','Fruit Salad with Nutella','سلطة فواكه مع نوتيلا','Salads',700,'bar'],['salad-fruit-nuts','Fruit Salad with Nuts','سلطة فواكه مع مكسرات','Salads',700,'bar'],['salad-fruit-cream-honey-nuts','Fruit Salad with Cream, Honey & Nuts','سلطة فواكه مع قشطة وعسل ومكسرات','Salads',800,'bar'],['hookah-two-apples-fakher','Two Apples - Fakher','تفاحتين - فاخر','Hookah',700,'service'],['hookah-two-apples-nakhla','Two Apples - Nakhla','تفاحتين - نخلة','Hookah',700,'service'],['hookah-two-apples-mix','Two Apples - Mix','تفاحتين - ميكس','Hookah',700,'service'],['hookah-lemon-mint','Lemon & Mint','ليمون ونعنع','Hookah',700,'service'],['hookah-grape-mint','Grape & Mint','عنب ونعنع','Hookah',700,'service'],['hookah-love','Love','لوف','Hookah',700,'service'],['hookah-head-change','Head Change','تغيير راس','Hookah',388,'service']
...
function migrate(state){
  ...
  for(const item of incoming){
    ...
    if(current){
      ...
      if(!['bar','kitchen','service'].includes(current.station))current.station=item.station;
